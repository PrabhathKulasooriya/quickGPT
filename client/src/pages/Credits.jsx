        ...
        {plans.map((plan) => (
          ...
          >
            <div className="flex-1 ">
              ...
              <p className="text-2xl font-semibold text-purple-600 dark:text-purple-300 mb-4">
                ${plan.price}
            ...
            <button
              ...
              className="mt-6 bg-purple-600 hover:bg-purple-800 text-white active:bg-purple-800 font-medium py-2 rounded transition-colors
